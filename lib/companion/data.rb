class Companion::Data
  ...
  class << self
    ...
    def all_vars
      all[current_line] ? all[current_line].local_vars + all[current_line].instance_vars + all[current_line].global_vars : []
    end
  ...
  # Instance
  attr_accessor :id, :trace_data, :local_vars, :instance_vars, :global_vars

  def save
    Companion::Data.all << self
  end
end
